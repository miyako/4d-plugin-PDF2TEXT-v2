...
public:
    // Constructor.
	HtmlPage(bool rawOrder, double wordBreakThreshold, bool noRoundedCoordinates, double lineBreakThreshold, bool rawLineBreak, bool ignoreHorizontalAlign, bool ignoreFont, double horizontalBreakThreshold, bool ignoreBoldItalic);
